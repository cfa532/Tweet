...
android {
    ...
    defaultConfig {
        ...
        minSdk = 29
        targetSdk = 37
        versionCode = 128    // Full release version code. Must be increased each time,
                            // and higher than mini version code.
                            // So full version can override mini version. 
        versionName = "63"  // compared with App Mimei version to check for upgrade.
...
//            isDebuggable = true
    ...
    productFlavors {
        ...
        create("play") {
            ...
            versionCode = 128  // Play version code increased for release
            buildConfigField("Boolean", "IS_MINI_VERSION", "false")
