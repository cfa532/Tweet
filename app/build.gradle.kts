...
android {
    ...
    defaultConfig {
        ...
        minSdk = 29
        targetSdk = 37
        versionCode = 119    // Full release version code. Must be increased each time,
                            // and higher than mini version code.
                            // So full version can override mini version. 
        versionName = "58"  // compared with App Mimei version to check for upgrade.
...
//            isDebuggable = true
    ...
    productFlavors {
        ...
        create("play") {
            ...
            versionCode = 119  // Play version code increased for release
            buildConfigField("Boolean", "IS_MINI_VERSION", "false")
